...
@Repository
interface CandleDailyRepository : CrudRepository<CandleDailyImpl?, SymbolDateId?> {
    @Query("select c from CandleDailyImpl c where c.symbol = ?1 and c.time > ?2 and c.time < ?3")
