...
```properties
BLOCKFROST_DATASOURCE_APIKEY=<yours>
...
API documentation is available at: http://localhost:8092/swagger-ui/index.html


## Build & Run Indexer with Docker
...
## Build & Run Indexer for Development
