...
class WingridersClassifierTest {
    ...
    fun computeSwap_SingleSwapSingleTransaction() {
        ...
        val knownSwapDTOS = listOf(
            SwapDTO(swapTxHash, 112501933, 0, "lovelace", "51a5e236c4de3af2b8020442e2a26f454fda3b04cb621c1294a0ef34424f4f4b", BigDecimal.valueOf(252819173), BigDecimal.valueOf(5000000000), 1),
        )
    ...
    fun computeSwap_DuelSwapSingleTransaction() {
        ...
        val knownSwapDTOS = listOf(
            SwapDTO(swapTxHash, 112587121, 0, "lovelace", "b6a7467ea1deb012808ef4e87b5ff371e85f7142d7b356a40d9b42a0436f726e75636f70696173205b76696120436861696e506f72742e696f5d", BigDecimal.valueOf(5391695121), BigDecimal.valueOf(35000000000), 1),
            SwapDTO(swapTxHash, 112587121, 0, "lovelace", "b6a7467ea1deb012808ef4e87b5ff371e85f7142d7b356a40d9b42a0436f726e75636f70696173205b76696120436861696e506f72742e696f5d", BigDecimal.valueOf(4050000000), BigDecimal.valueOf(26169677478), 0),
        )
        val txDTOs: List<FullyQualifiedTxDTO> = Gson().fromJson<List<FullyQualifiedTxDTO>>(
