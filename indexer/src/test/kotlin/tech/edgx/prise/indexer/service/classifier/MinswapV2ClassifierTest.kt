...
class MinswapV2ClassifierTest {
    ...
    fun computeSwap_SingleTransaction_SingleSwap_2() {
        ...
        assertEquals(knownSwaps.size, computedSwaps.size)
        knownSwaps.zip(computedSwaps).forEach {
            println("Comparing: ${it.first} to ${it.second}")
            assertTrue { it.first.txHash == it.second.txHash }
            assertTrue { it.first.slot == it.second.slot }
            assertTrue { it.first.dex == it.second.dex }
    ...
    fun computeSwap_SingleTransaction_SingleSwap_3() {
        ...
        val knownSwaps = listOf(
            Swap("f01615dc120442a43d08dbcd13c80044aafbde1ddb7c7e8899e3222e3a556858", 132216341, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(2061343905), BigInteger.valueOf(9956660000), DexOperationEnum.BUY.code),
            Swap("f01615dc120442a43d08dbcd13c80044aafbde1ddb7c7e8899e3222e3a556858", 132216341, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(9862068966), BigInteger.valueOf(48129095766), DexOperationEnum.SELL.code),
        )
        val txDTO: FullyQualifiedTxDTO = Gson().fromJson(
            File("src/test/resources/testdata/${DexEnum.MINSWAPV2.nativeName}/transaction_qualified_$swapTxHash.json")
                .readText(Charsets.UTF_8)
    ...
    fun computeSwap_SingleTransaction_SingleSwap_4() {
        ...
        val knownSwaps = listOf(
            Swap(txHash, 132239546, DexEnum.MINSWAPV2.code, "lovelace", "a3931691f5c4e65d01c429e473d0dd24c51afdb6daf88e632a6c1e516f7263666178746f6b656e", BigInteger.valueOf(129610777 ), BigInteger.valueOf(5000000000), DexOperationEnum.BUY.code),
        )
    ...
    fun computeSwap_SingleTransaction_SingleSwap_Type3_SwapExactOut() {
        ...
        val knownSwaps = listOf(
            ...
            Swap(swapTxHash, 132219880, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(197129582), BigInteger.valueOf(1000000000), DexOperationEnum.SELL.code),
        )
        val txDTO: FullyQualifiedTxDTO = Gson().fromJson(
            File("src/test/resources/testdata/${DexEnum.MINSWAPV2.nativeName}/transaction_qualified_$swapTxHash.json")
                .readText(Charsets.UTF_8)
    ...
    fun computeSwaps_SingleTransaction_QtySwaps_Type3_SwapExactOut() {
        ...
        val knownSwaps = listOf(
            Swap(txHash, 130934066, DexEnum.MINSWAPV2.code, "lovelace", "1d7f33bd23d85e1a25d87d86fac4f199c3197a2f7afeb662a0f34e1e776f726c646d6f62696c65746f6b656e", BigInteger.valueOf(17523004082 ), BigInteger.valueOf(35449239058 ), DexOperationEnum.SELL.code),
            Swap(txHash, 130934066, DexEnum.MINSWAPV2.code, "lovelace", "1d7f33bd23d85e1a25d87d86fac4f199c3197a2f7afeb662a0f34e1e776f726c646d6f62696c65746f6b656e", BigInteger.valueOf(2250000000 ), BigInteger.valueOf(4586658642 ), DexOperationEnum.SELL.code),
            /* This gets filtered out since is type==3; SWAP_EXACT_OUT */
    ...
    fun computeSwaps_QtyTransaction_QtySwaps_1() {
        ...
        val knownSwaps = listOf(
            Swap("14f20e4a633f81ff41904d580bf6837f9a09b6cc6864951fe53c133a67b2a3c3", 132220815, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(510283767), BigInteger.valueOf(2619000000), DexOperationEnum.BUY.code),
            Swap("94cd847fca66c2953645817ec461c55c2d5e4ae3c6d3c2f9d54576a2e45873ba", 132220695, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(977832974), BigInteger.valueOf(5000000000), DexOperationEnum.BUY.code),
            Swap("592ac794f7ea60aba502b44aa436178626bef087ce7f05bf4a53dbd1456287be", 132219880, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(197129582), BigInteger.valueOf(1000000000), DexOperationEnum.SELL.code),
            Swap("069b365ef33ed07bb087682d3a1f5cb0f3494fad8daa753a7c39ccc464539f95", 132219194, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(1000000000), BigInteger.valueOf(5087991254), DexOperationEnum.SELL.code),
            Swap("f37ed76e1466489d833e335ffba1b27b578e1ed86da7c6bf391947318a0a6814", 132218522, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(100000000), BigInteger.valueOf(510177661), DexOperationEnum.SELL.code),
            Swap("67afe34975df81820e4599d4a3f1f2776c4debdcffcfb95f15b61fa039a4c56b", 132218404, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(2000000000), BigInteger.valueOf(10249480041), DexOperationEnum.SELL.code),
            Swap("86cf291baa9d8341d2ef246cd00c4d4333a657c6a7bbd32789bbaa00985b80bb", 132218278, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(4200682701), BigInteger.valueOf(21555091558), DexOperationEnum.BUY.code),
            Swap("f5bda63b84377e00165376e82a1b904f7a126f9f9c1723fa5f5ac42d5621b278", 132218086, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(5123289763), BigInteger.valueOf(25773195876), DexOperationEnum.BUY.code),
            Swap("6724d44b03ceb59324db8ecaafcd7f4dc2b9e6cd0bc6caa67152917e41d169c5", 132217553, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(31910891), BigInteger.valueOf(158790780), DexOperationEnum.BUY.code),
            Swap("695de5db3cebeed45d563420433490b61312807436e1e0b440835d7a11a2f3dd", 132217469, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(318685018), BigInteger.valueOf(1584627648), DexOperationEnum.BUY.code),
            Swap("a4522d210cbf55f4ebf13c538e32785bea2a10257937db526994c1cfd4f012a9", 132217188, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(452563103), BigInteger.valueOf(2246673856), DexOperationEnum.BUY.code),
            Swap("3932955b1512124deee152f55e844c20ee6903e37bca597576530eb27457d546", 132216619, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(5302139120), BigInteger.valueOf(26006408598), DexOperationEnum.BUY.code),
            Swap("f01615dc120442a43d08dbcd13c80044aafbde1ddb7c7e8899e3222e3a556858", 132216341, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(2061343905), BigInteger.valueOf(9956660000), DexOperationEnum.BUY.code),
            Swap("f01615dc120442a43d08dbcd13c80044aafbde1ddb7c7e8899e3222e3a556858", 132216341, DexEnum.MINSWAPV2.code, "lovelace", "64f7b108bd43f4bde344b82587655eeb821256c0c8e79ad48db15d1844454449", BigInteger.valueOf(9862068966), BigInteger.valueOf(48129095766), DexOperationEnum.SELL.code),
        )
    ...
    fun computeSwaps_QtyTransaction_QtySwaps_3() {
        val knownSwaps = listOf(
            Swap("fa30415a3d5e336b80d940d880461bcf19cd1c63b2981ccbe51c1f30557feb82", 132239546, DexEnum.MINSWAPV2.code, "lovelace", "a3931691f5c4e65d01c429e473d0dd24c51afdb6daf88e632a6c1e516f7263666178746f6b656e", BigInteger.valueOf(129610777 ), BigInteger.valueOf(5000000000), DexOperationEnum.BUY.code),
    ...
    companion object {
        ...
        fun filterSwapsByType(swaps: List<Swap>, txDTOs: List<FullyQualifiedTxDTO>, types: List<Int>): List<Swap> {
            val filterMask = createSwapsFilterMasks(txDTOs, types)
            return swaps.groupBy { it.txHash }
                .flatMap {
