...
class MinswapClassifierTest {
    ...
    fun computeSwap_SingleSwapSingleTransaction_2() {
        ...
        val knownSwaps = listOf(
            Swap(swapTxHash, 112553479, 2, "lovelace", "279c909f348e533da5808898f87f9a14bb2c3dfbbacccd631d927a3f534e454b", BigInteger.valueOf(1789513117), BigInteger.valueOf(701549), DexOperationEnum.SELL.code),
        )
        val txDTOs: List<FullyQualifiedTxDTO> = Gson().fromJson<List<FullyQualifiedTxDTO>>(
    ...
    fun computeSwap_NilSwap_3() {
        ...
        val txDTO: FullyQualifiedTxDTO = Gson().fromJson(
            ...
            //.filter { it.txHash == swapTxHash }
        val computedSwaps: List<Swap> = MinswapClassifier.computeSwaps(txDTO)
        println("Computed swaps, #: ${computedSwaps.size}")
        assertTrue(computedSwaps.isEmpty())
    }
    ...
    fun computeSwaps_SingleSwapSingleTransaction_5() {
        ...
        val knownSwaps = listOf(
            Swap(swapTxHash, 112501470, DexEnum.MINSWAP.code, "lovelace", "1d7f33bd23d85e1a25d87d86fac4f199c3197a2f7afeb662a0f34e1e776f726c646d6f62696c65746f6b656e", BigInteger.valueOf(270000000), BigInteger.valueOf(1045332878), DexOperationEnum.SELL.code),
        )
        val txDTO: FullyQualifiedTxDTO = Gson().fromJson(
            File("src/test/resources/testdata/${DexEnum.MINSWAP.nativeName}/transaction_qualified_$swapTxHash.json")
                .readText(Charsets.UTF_8)
